...
public class EnemyStateManagerAxe : MonoBehaviour
{
    ...
    ZoneTriggerManagerAxe zoneManager; // Менеджер зон, который отвечает за то, в какой зоне появился меч игрока
    ...
    public void SwitchState(BaseStateAxe newState) // Метод, задающий текущее состояние
    {
